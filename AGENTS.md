...
- `26.7.caddyfile`: Maho 26.7 and 26.8, which introduced the API Platform entry point `public/rest.php`
- `26.9.caddyfile`: Maho 26.9+, which stopped denying `.md` URLs. A page URL with a `.md` suffix is the markdown version of that page, generated by PHP (MahoCommerce/maho#1350). Used by `nightly` too
